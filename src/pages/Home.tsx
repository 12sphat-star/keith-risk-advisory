...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>
          Structured Health &amp; Life Insurance | Virginia | The Fin Coach
        </title>
        <meta
          name="description"
      ...
      <main className="home-page">
        ...
        <section className="credibility-strip">
          <div className="container">
            <p>
              20+ Years in Banking, Lending &amp; Risk Management | Structured
              Health &amp; Life Planning for Business Owners &amp; Individuals
            </p>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="process-grid">
              <div className="process-step">
                ...
                <p>
                  We review your current coverage and basic income structure to
                  understand how everything is set up today.
                </p>
              </div>
              ...
              <div className="process-step">
                ...
                <p>
                  We determine whether your current structure is aligned — or if
                  there are exposure areas worth improving.
                </p>
              </div>
              ...
              <div className="process-step">
                ...
                <p>
                  If changes make sense, we outline options. If your structure
                  is solid, we confirm it. No pressure either way.
                </p>
              </div>
            </div>
          ...
          <div className="container">
            ...
            <div className="mistakes-grid">
              <div className="mistake-card">
                ...
                <p>
                  The lowest monthly cost often leads to higher long-term
                  exposure. Deductibles, network limitations, and out-of-pocket
                  risk matter.
                </p>
              </div>
              ...
              <div className="mistake-card">
                ...
                <p>
                  Coverage decisions affect taxes, income stability, and
                  long-term business continuity — yet they’re often treated as
                  isolated purchases.
                </p>
              </div>
              ...
              <div className="mistake-card">
                ...
                <p>
                  As income changes and businesses scale, coverage structures
                  should evolve. Many don’t.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="faq-section">
          <div className="container">
            ...
            <div className="faq-item">
              ...
              <p>
                Yes. A review confirms whether your current health and life
                coverage aligns with your income structure, business model, and
                long-term goals.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                While many clients are business owners and self-employed
                professionals, individuals and families across Virginia also
                benefit from structured reviews.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                No. The purpose of the review is clarity. If your structure is
                sound, that is confirmed. If adjustments are needed, options are
                outlined.
              </p>
            </div>
          </div>
