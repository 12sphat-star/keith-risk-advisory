...
const HealthInsurance = () => {
  return (
    <>
      <Helmet>
        <title>
          Health Insurance Review for Virginia Business Owners | The Fin Coach
        </title>
        <meta
          name="description"
          content="Structured health insurance review for Virginia business owners, self-employed professionals, and small teams. Serving Hampton Roads and surrounding communities."
        />
      </Helmet>
      ...
      <div className="health-page">
        ...
        <section className="health-hero">
          ...
          <div className="health-hero-image">
            <img
              src={healthImage}
              alt="Advisor reviewing structured health coverage with business owner"
            />
          </div>
        </section>
